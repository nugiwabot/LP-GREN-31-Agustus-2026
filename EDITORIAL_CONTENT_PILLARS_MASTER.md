...
```
                                    ┌──────────────────────────────────────────────┐
                                    │    PROFIL TARGET PEMBELI ASET RP 2M - RP 4M  │
                                    └──────────────────────┬───────────────────────┘
                                                           │
         ┌─────────────────────┬───────────────────────────┴───────────────────────────┬─────────────────────┐
         ▼                     ▼                                                       ▼                     ▼
...
| Segmen Pembeli | Profil & Karakteristik | Sudut Pandang Emosional & Kebutuhan | Kata Kunci Pencarian di Google/AI |
| :--- | :--- | :--- | :--- |
| **1. Pengusaha Daerah & Juragan Bisnis** | Pemilik bisnis di Jabodetabek, Karawang, Cirebon, Majalengka, Garut, Tasik, Bandung, Luar Pulau. | *"Memarkir keuntungan usaha ke aset fisik yang aman, nilainya naik, dan menghasilkan cashflow pasti tanpa tergerus inflasi."* | `diversifikasi aset pengusaha`, `investasi properti jawa barat`, `prospek kawasan jatinangor` |
| **2. Profesional Senior, Dokter Spesialis, Eksekutif & Calon Pensiunan** | Usia 48–62 th, dokter spesialis, mantan direksi, PNS/BUMN senior, profesional mapan. | *"Uang pensiun jangan disimpan di deposito yang bunganya kecil. Belikan aset nyata yang memberi 'gaji bulanan' rutin seumur hidup."* | `investasi aman dana pensiun`, `passive income properti hari tua`, `properti sewa vs deposito` |
| **3. Investor Serial Properti Komersial** | Investor yang sudah memiliki properti sewa di kota lain dan ingin ekspansi portofolio. | *"100.000 mahasiswa aktif di Jatinangor adalah pasar sewa abadi. Butuh gedung siap huni dengan yield 8-12% dan sistem kelola autopilot."* | `investasi properti yield tinggi`, `bisnis kos autopilot`, `beli gedung rukost jatinangor` |
| **4. Keluarga Mapan (Ultra Affluent)** | Keluarga kaya yang ingin diversifikasi portofolio dan menyiapkan aset produktif untuk anak cucu. | *"Membeli aset tanah tapak Ring-1 kampus sebagai instrumen pelindung kekayaan (wealth preservation) jangka panjang."* | `capital gain tanah unpad`, `investasi aset warisan`, `properti komersial bandung timur` |
...
* **Untuk Artikel Makro / Wilayah (Pilar 1):**  
  > *"Ingin mengamankan aset properti tapak di kawasan Ring-1 UNPAD Jatinangor sebelum harga tanah melonjak lebih tinggi? Pelajari portofolio gedung siap huni GREN Propertykost bersama tim konsultan kami."*

* **Untuk Artikel Finansial / Pensiun (Pilar 2 & 3):**  
  > *"Miliki 1 gedung rumah kost utuh siap sewa dengan estimasi passive income Rp 150–300+ Juta/tahun, lengkap dengan sistem kelola profesional dan garansi okupansi. Konsultasikan rencana diversifikasi Anda sekarang."*
